      ...
      >
        <div>
          <div className="flex">
            <div className="w-full flex  gap-3 items-end px-4 py-2">
              ...
              <div>
                ...
                <h3 className="font-semibold font-">AcrossTheGlob</h3>
              </div>
              <div>
          ...
          <button onClick={()=> (
            ...
            )} className={` ${activeRole === 'user'?'bg-primary-color  active:scale-90 text-white':'bg-white'}  transition-all duration-200 btn  shadow-lg p-3 rounded-lg px-10`}>User</button>
          <button onClick={()=> (
            setActiveRole('admin'),
            navigate('/dashboard/manage-user')
            )} className={`${activeRole === 'admin'?'bg-primary-color active:scale-90 text-white':'bg-white'} transition-all duration-200  btn  shadow-lg p-3 rounded-lg px-10`}>Admin</button>
         </div>
