...
import Link from "../../components/quickLinks/Link";
//icons
import { ContactInformationIcon, DeliveryInfoIconIcon, FAQsIcon, FeedbackIcon,
    LiveChatSupportIcon, OrderingGuideIcon, PrivacyPolicyIcon, TechnicalSupportIcon, TermsAndServicesIcon } from "../../components/quickLinks/LinkIcons";
