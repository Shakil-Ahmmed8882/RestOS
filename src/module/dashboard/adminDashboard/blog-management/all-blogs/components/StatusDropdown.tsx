  ...
  return (
    ...
    >
      <div
        className={`${
          status === "approved"
            ? "bg-[#f0fff2] text-[10px] sm:text-sm md:text-md text-primaryColor"
            : "bg-[#ffeef7] text-[10px] sm:text-sm md:text-md text-deepPink"
      ...
      {hoveredRow === record._id && dropdownType === "status" && (
        ...
        >
          <h1 className="bg-gradient-to-r from-primaryColor/30 to-transparent   p-1 text-xl">Status</h1>
