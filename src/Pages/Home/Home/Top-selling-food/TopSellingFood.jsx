  ...
  return (
    ...
    <div className={` max-w-6xl mx-auto md:flex pt-8   gap-3 mt-24 text-center`}>
      ...
      <div className="flex-1 w-full md:w-2/3">
        <h1 className={`text-3xl md:text-4xl lg:text-6xl font-bold pb-1 text-center my-8 ${theme == 'dark'?'text-[white]':''}`}>Top selling foods</h1>
        <p className={` ${theme == 'dark'?'text-[#cfcfcf]':''} w-[60%] my-2 pb-8 mx-auto`}>A diverse restaurant serving delicious cuisine from around the world, offering a variety of dishes to satisfy every palate. Whether you're a fan of spicy Mexican, savory Italian, or exotic Asian  of global cuisine at its finest!" </p>
