...
import DemoImage, { DemoFoodCard } from "./DemoImage";
import { url2 } from "../../Dashboard/shared/charts/data";
...
const Banner = () => {
  ...
  return (
    <section className=" bg-[#f8f8f8] py-8 pt-16">
      ...
      <Button className="p-5 text-primaryColor outline outline-[1px] outline-primaryColor px-11">Discover more</Button>
